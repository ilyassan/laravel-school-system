		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="side-item side-item-category">Grades</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ route('grades.index') }}">
							...
							<span class="side-menu__label">Grades</span><i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('grades.index') }}">Grades Table</a></li>
							@if (auth()->user()->isTeacher())
								<li><a class="slide-item" href="{{ route('grades.create') }}">Create Grade</a></li>
							@endif
						</ul>
					</li>
					...
					@if (auth()->user()->isAdmin())
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="{{ route('invoices.index') }}">Invoices Table</a></li>
								<li><a class="slide-item" href="{{ route('invoices.create') }}">Create Invoice</a></li>
							</ul>
						</li>
					@endif
